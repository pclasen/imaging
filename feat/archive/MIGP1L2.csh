...
# Usage: ./MIGP1L2.csh <dir> <sub> <model> <L1design> <examSub> <L2 design>		#
# p.clasen																		#
#################################################################################
...
set design = $feat/P1/$mod/$examFeat/designFiles
...
##Make Design File
cp $dir/$examSub/feat/P1/$mod/$examFeat/$examGfeat.gfeat/design.fsf $ofile								
