				...
				# get functional ROIs into native space
					...
					if ($roi == FgS || $roi == FUSI_FgS) then
						...
						if (-f $rundir/rois/FgS_ntv.nii.gz) then
							...
							# set functional ROI
							set funROI = $DIR/$sub/feat/P1/M1/glm/FE_U05_MO.gfeat/cope1.feat/thresh_zstat1.nii.gz
	 					...
	 					if ($roi == FUSI_FgS) then
							...
							# restrict functional mask by fusiform in native space and binarize
	 						fslmaths $rundir/rois/FgS_ntv.nii.gz -mul $rundir/rois/FUSIHO_ntv.nii.gz -bin $rundir/rois/FUSI_FgS_ntv.nii.gz
						...
						if (-f $rundir/rois/SgF_ntv.nii.gz) then
							...
							# set functional ROI
							set funROI = $DIR/$sub/feat/P1/M1/glm/FE_U05_MO.gfeat/cope2.feat/thresh_zstat1.nii.gz
	 					...
	 					if ($roi == PH_SgF) then
							...
							# restrict functional mask by fusiform in native space and binarize
	 						fslmaths $rundir/rois/SgF_ntv.nii.gz -mul $rundir/rois/PHHO_ntv.nii.gz -bin $rundir/rois/PH_SgF_ntv.nii.gz
